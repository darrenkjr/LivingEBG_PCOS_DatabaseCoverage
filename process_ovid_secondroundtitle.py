...
def main():
    ...
    embase_manual_path = os.path.join('title_searches/embase_manual.ris')
    pubmed_results_path = os.path.join('title_searches/pubmed_2nd_titlesearch.ris')
    pubmed_manual_path = os.path.join('title_searches/pubmed_manual.ris')

    embase_1stround_results_path = 'retrieval_results/api_retrieved_embase.xlsx'
    oa_ss_pubmed_results_path = 'retrieval_results/api_retrieved.xlsx'
